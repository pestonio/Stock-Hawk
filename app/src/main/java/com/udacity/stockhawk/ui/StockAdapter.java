    ...
    public void onBindViewHolder(final StockViewHolder holder, final int position) {
        ...
        holder.symbol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                detailIntent.putExtra("Symbol", cursor.getString(Contract.Quote.POSITION_SYMBOL));
                detailIntent.putExtra("History", cursor.getString(Contract.Quote.POSITION_HISTORY));
        ...
        holder.price.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                detailIntent.putExtra("Symbol", cursor.getString(Contract.Quote.POSITION_SYMBOL));
                detailIntent.putExtra("History", cursor.getString(Contract.Quote.POSITION_HISTORY));
                holder.price.getContext().startActivity(detailIntent);
            }
        });
        ...
        holder.change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                detailIntent.putExtra("Symbol", cursor.getString(Contract.Quote.POSITION_SYMBOL));
                detailIntent.putExtra("History", cursor.getString(Contract.Quote.POSITION_HISTORY));
                holder.change.getContext().startActivity(detailIntent);
            }
        });
